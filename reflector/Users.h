...
public:
	...
	// operation
	void   Hearing(const CCallsign &, const CCallsign &, const CCallsign &, const std::string &proto = "");
	void   Hearing(const CCallsign &, const CCallsign &, const CCallsign &, const CCallsign &, const std::string &proto = "");
